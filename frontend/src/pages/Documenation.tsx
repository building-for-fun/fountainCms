...
const Documentation: React.FC = () => (
  <HomeLayout>
    <div className="flex bg-gradient-to-br from-indigo-50 via-purple-50 to-blue-100 items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden hover:shadow-xl transition-shadow duration-300">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg text-slate-700 leading-relaxed bg-indigo-50 p-6 rounded-lg border-indigo-500">
            {GETTING_STARTED}
          </p>
        </section>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-indigo-50 to-purple-50 border-b-2 border-indigo-300">
                  <th className="text-left px-6 py-4 font-bold text-indigo-600 text-sm">Method</th>
